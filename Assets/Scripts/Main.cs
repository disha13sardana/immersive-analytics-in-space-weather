...
namespace Scenes
{
    public class Main : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            // Left sliding bar handle with data line
            ...
            leftSlidingBarHandleModel.Rotation = new Vector3(90f,0f,180f);
            ...
            rightSlidingBarHandleModel.CenterPosition = new Vector3(0f, 10f, -58f);
